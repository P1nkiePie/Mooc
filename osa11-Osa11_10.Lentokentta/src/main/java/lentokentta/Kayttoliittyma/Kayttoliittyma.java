 ...
 */
package lentokentta.Kayttoliittyma;
...
public class Kayttoliittyma {
    ...
    private Hallinta lentohallinta;
    private Scanner lukija;

    public Kayttoliittyma(Hallinta lentohallinta, Scanner lukija) {
    ...
    private void lisaaLento() {
        System.out.print("Anna lentokoneen tunnus: ");
        Koneet lentokone = kysyLentokone();
    ...
    private void tulostaLentokoneet() {
        for (Koneet lentokone : lentohallinta.getLentokoneet()) {
    ...
    private void tulostaLentokone() {
        ...
        Koneet kone = kysyLentokone();
        System.out.println(kone);
        System.out.println();
    }

    private Koneet kysyLentokone() {
        Koneet lentokone = null;
